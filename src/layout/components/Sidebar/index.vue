...
export default {
  ...
  computed: {
    ...
    routes() {
      ...
      if (moduleName) {
        console.log(moduleName, this.$router.options.routes.filter(i => i.meta && i.meta.module === moduleName))
        return this.$router.options.routes.filter(i => i.meta && i.meta.module === moduleName)
      }
