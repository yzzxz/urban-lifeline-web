<template>
  <el-dialog :title="addOrEdit | formatTitle" width="45rem" append-to-body :close-on-click-modal="false" :visible.sync="isShow"
    ...
    <el-form ref="form" label-width="8rem" :model="formData" :rules="rules">
      <el-form-item label="评估单元" prop="evaluationUnit">
        <el-input v-model="formData.evaluationUnit" maxlength="50" clearable />
      </el-form-item>
      ...
      <el-form-item label="备注" prop="remarks">
        <el-input v-model="formData.remarks" type="textarea" placeholder="请输入" maxlength="20" clearable />
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      rules: {
        evaluationUnit: [{ required: true, message: '请输入', trigger: 'blur' }]
      }
    }
  },
  methods: {
