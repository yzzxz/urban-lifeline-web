  ...
  <div class="app-container">
    ...
    <el-form :model="query" label-width="6rem" inline class="query-form">
      <el-form-item label="评估单元">
        <el-input v-model="query.evaluationUnit" />
      </el-form-item>
    ...
    <div class="table-container">
      ...
      <el-table ref="tableWrapper" v-loading="tableLoading" border stripe row-key="id" :data="tableData"
        ...
        <el-table-column prop="evaluationUnit" label="评估单元" min-width="120" />
...
export default {
  ...
  data() {
    return {
      uri: '/api/scl/v1/scl/sclEvaluation/',
      deleteAllId: 'sclEvaluationIds'
    }
  },
  activated() {},
  mounted() {},
